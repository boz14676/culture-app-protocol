 ...
 *
 * @apiExample Example usage:
 * curl -i http://localhost/videos?q[videoable_type]=article_category&q[videoable_id]=1&page=1&per_page=10
 *
 * @apiUse BadRequestError
 */
 ...
 * @apiSuccess {String} thumbnail   缩略图
 * @apiSuccess {String} url         视频地址
 * @apiSuccess {Number} next_id     下一个视频ID
 *
 * @apiExample Example usage:
